...
/* 41 */       this.createWorldGui.field_146334_a = this.generatorInfo.toString();
...
/*    */     } else if (button.id == 6) {
	...
	/* 45 */       button.displayString = /*I18n.format("planetoid.gui.waterfloor", new Object[0])*/"Water Floor" + ": " + (this.generatorInfo.waterFloor ? "on" : "off");
	/*    */     } 
/*    */   }
/*    */ 
/*    */ 
...
/* 55 */     drawCenteredString(this.fontRendererObj, "Planetoid World", this.width / 2, 8, 16777215);
/* 56 */     super.drawScreen(par1, par2, par3);
/*    */   }
/*    */ }


/* Location:              C:\Minecraft Modding\DecompPlanetoid\Planetoid-Mod-1.7.10-deobf.zip!\tennox\planetoid\GuiCreatePlanetoidWorld.class
